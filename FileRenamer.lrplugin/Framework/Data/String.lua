...
--
--  @param      path        disk folder/file or collection or keyword path..
--
...
function String:componentsToPath( comps, sep )
    ...
    elseif sep == nil then sep = app:pathSep() -- assume OS disk path separator if no hint via first component.
    -- else sep = sep
    end
    local path = comps[1]
    for i = 2, #comps do
